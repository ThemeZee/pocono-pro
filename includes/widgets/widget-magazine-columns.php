...
class Pocono_Pro_Magazine_Columns_Widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct(
			...
			array(
				...
				'description' => esc_html__( 'Displays your posts from two selected categories.', 'pocono-pro' ),
	...
	private function default_settings() {
		...
		$defaults = array(
			'category_one'       => 0,
			'category_two'       => 0,
			'category_one_title' => esc_html__( 'Left Category', 'pocono-pro' ),
			'category_two_title' => esc_html__( 'Right Category', 'pocono-pro' ),
			'number'             => 4,
			'highlight_post'     => true,
		);
	...
	function category_title( $args, $settings, $category_id, $category_title ) {
		...
		if ( ! empty( $widget_title ) ) :
			...
			$widget_title = pocono_magazine_widget_title( $widget_title, $category_id );
